  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: `url(/images/all-img/bgloginpw2.jpg)`,
        }}
      >
...
s lg:w-1/2"
          >
            <div className="flex justify-center items-center min-h-screen pr-4">
              <Link href="/" className="flex gap-2 items-center">
                <PwLogoAvatarIcon fontSize="47px" />
                <PwLogoNameIcon fontSize="45px" />
              </Link>
            </div>
          </div>
            ...
            <div className="bg-default-50  relative h-auto  lg:mr-[150px] mr-auto p-10 md:rounded-md max-w-[520px] w-full ml-auto text-2xl text-default-900  mb-3">
              ...
              <div className="text-center 2xl:mb-10 mb-5">
                ...
                <div className="text-default-500  text-base">
                  Faça login na sua conta para começar a usar a Person Wallet
                </div>
              </div>
              <LoginForm />
          ...
          <div className="absolute bottom-0 lg:block hidden text-white py-5 px-5 text-xl w-full">
            Esteja sempre no controle de sua {" "}
            <span className="text-white font-bold ms-1">Vida Financeira.</span>
          </div>
        </div>
      </div>
    </>
